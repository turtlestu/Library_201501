	...
	function check1(){
		...
		if (select == 'Role' & textValue != ''){
			if(textValue == '1' || textValue == '2' || textValue=='3'){
				...
				alert('please type Role in 1:User 2:Manager 3:Administrator');
			}
		}else{
			$('#formSearch').submit();
		}
...
<div id="condition">
<p class="title">Find a user</p>
<form id="formSearch" action='user?type=search' method='POST'>
<table ALIGN='center' >
<tr>
<td width='40%'>
<label>
...
<td><p class='content'>
<input type='text' id='value' name="value" class='textbox'>
</p></td>
</tr>
</table>
...
<%
	...
	if(userList!=null){
		...
		while(userIt.hasNext()){
			out.print("<form action='user?type=detail' method='POST'>");
			out.print("<tr>");
