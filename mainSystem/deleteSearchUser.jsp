	...
	var select = $('#dataType').val();
		...
		if (select == 'Role' & textValue != ''){
			if(textValue == '1' || textValue == '2' || textValue=='3'){
				...
				alert('please type Role in 1:Administrator 2:Manager 3:User');
			}
		}else{
			$('#formSearch').submit();
		}
...
<div id="condition">
<p class="title">Find a user to delete</p>
<form id='formSearch' action='user?type=search&function=delete' method='POST'>
<table ALIGN='center' >
<tr>
<td width='40%' >
<label>
<select name='dataType' id='dataType' style="width:140px;">
...
<%
	...
	if(userList!=null){
		...
		while(userIt.hasNext()){
			out.print("<form action='user?type=detail&function=delete' method='POST'>");
			out.print("<tr>");
