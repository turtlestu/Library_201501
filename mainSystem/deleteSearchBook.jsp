...
<div id="condition">
<p class="title">Find a book to delete</p>
<form action='book?type=search&function=delete' method='POST'>
<table ALIGN='center' >
<tr>
<td width='32%'>
<label>
...
<!------------------------------------------->
	<div id="result"> 
	<form action='book?type=detail&function=delete' method='POST' >
<%
	...
	if(bookList!=null){
		...
		while(bookIt.hasNext()){
			out.print("<form action='book?type=detail&function=delete' method='POST' >");
			out.print("<tr>");
